...
rule nthash_hashed_default_creds_accelerated_networks
{
    meta:
        id = "7hPQL0ZAKHAdLKZ6uPeE32"
...
rule mysql323_hashed_default_creds_accelerated_networks
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_accelerated_networks
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{MD5}bC/+dv3tQzWZyKLwemkCDQ=="
    $a1="{MD5}4Mvw5i0DeW8x2kcJloK3Kw=="
condition:
    ($a0 and $a1)
}

rule ldap_sha1_hashed_default_creds_accelerated_networks
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="74c80d057102786413d6f7b6a92759d249204aea7b4d7eee379bf69652b62180d1598ab045c2db9876432d4d303c0811"
...
strings:
    $a0="cb2bd491a6e91e1e1745d88d953dad5d8df28f471288d85658a14d8d26a05b2f"
