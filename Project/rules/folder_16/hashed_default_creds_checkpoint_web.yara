...
rule nthash_hashed_default_creds_checkpoint_web
{
    meta:
        id = "28gSARvCrgJ4smubXNES1B"
        fingerprint = "e22b959d0997180a94c924026cf9141dad3d257fd75cc324cb44adefa4104fc2"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
...
rule mysql323_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="3274f8455be84b8c7d79f9bd93e6c8520d13f6bd2855f3bb9c006ca9f3cce25d4b924d0370f8af4e27a350fd2baeef58bc37e0f4e4a403fe64c98017fa012757"
...
rule base64_hashed_default_creds_checkpoint_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
