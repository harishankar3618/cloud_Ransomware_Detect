...
rule mysql323_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{MD5}RvlMjeFPs2aAhQdo/xt/Kg=="
    $a1="{MD5}46/tAEewgFnQ+toQ9ADB5Q=="
condition:
    ($a0 and $a1)
}

rule ldap_sha1_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{SHA}Bf50YcYHwzIpdy1AJQVgEBan0Oo="
...
rule sha1_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="05fe7461c607c33229772d402505601016a7d0ea"
    $a1="4e7afebcfbae000b22c7c85e5560f89a2a0280b4"
condition:
    ($a0 and $a1)
}

rule sha384_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="e58df53ed3bc705d5b921ba27a6101b88380f0fabac71a1df84834254e1f1b31d7a7700c4388e36f0f76b9148d90985b"
...
rule sha512_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="4aeb2000b9de5858f5e5e0b7eda52f253caf19582c67cbbb453be6987ecc1baf27d75670e39f78058fb1ebee3d16b83d1cbdc8d3628636377b2458ea5bf12ff2"
...
rule blake2b_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="32bdc7755a78713f5bc2b4719fea5ca617ce5d9e8e33e119846f07d33c617f6ce520151855f31bba3b47d75416ec8cee8de77eafb3d0d9c888f867f04c59973f"
...
rule blake2s_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="db08254e3fec401a590d6d42dcdb347fdd2ad065b08c9405b749064616d12942"
...
rule sha3_256_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="bbde77f4c9765f5e28c3504c70f62d1736343f62df721f036b6e3a0eb248cba9"
    $a1="bbe53f6251b67bef7e6e8c008916c4c80cfdb55175e912c5ac50c73246425fb1"
condition:
    ($a0 and $a1)
}

rule sha3_384_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="96280598824443133f7938be34448e255efb6adac05ba5f5f0b36863e1869bc425db809d40d5823030ff5cbeda0b9b87"
    $a1="43d90448744d5ae5f38c8dc894771ea4820eece7e566e101768132daf4042c3386b746fe72ca836d66ae4ddc3ec4284d"
condition:
    ($a0 and $a1)
}

rule sha3_512_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="164f04b29f50874c9330ee60d23a6ff04279c8b21a79afb5721602c6b97e2ac24d7c2070eba5827cab5f3b503bfac26539ec479921c1abadeac4980fcbf3b8a6"
...
rule base64_hashed_default_creds_rizen
{
    meta:
        version = "1.0"
        status = "RELEASED"
