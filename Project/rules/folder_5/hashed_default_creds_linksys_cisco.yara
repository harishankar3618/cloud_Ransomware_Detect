...
rule mysql323_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="{MD5}aSV2hlja6T/3KqB8v9TWTA=="
    $a3="{MD5}7hHLsZBS5AsHqsDKBgwj7g=="
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule ldap_sha1_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="{SHA}K8RV9Hwr3ztTp6OpTYg1JPuQLzU="
    $a3="{SHA}Et6pb+wgWTVmq3VpLJlJWWgzrck="
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule md5_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="6925768658dae93ff72aa07cbfd4d64c"
    $a3="ee11cbb19052e40b07aac0ca060c23ee"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha1_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="2bc455f47c2bdf3b53a7a3a94d883524fb902f35"
    $a3="12dea96fec20593566ab75692c9949596833adc9"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha384_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="07de10e6d781745b055f19fe46b0cfde3a5d8bb06fdfa917aac891ff9b054db42f2442a5a0ffd0b533d73d48dd998266"
    $a3="46cb0934bc1afda5a06031f9849b0281bb5cd03767e318e0a877c5a51962dbaa7d7f0dc146ce1bd85176d856907aa2c9"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha224_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="bd9c9612d7e24fff9b90a050c6fe1e557bcc6726f2f28258273635f6"
    $a3="147ad31215fd55112ce613a7883902bb306aa35bba879cd2dbe500b9"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha512_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="fca53da244418a55e6bb69c48d1161e2bc55ec17fc8d773803726a1bf497ff6f4c47b87d81cac2857f272776fed2cf7d0153c2d9ede90b1ea3431210c28536c0"
...
rule sha256_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="addc914d2e650c357e216b5319410f669660fec5cf37adbea057d82494528ac9"
    $a3="04f8996da763b7a969b1028ee3007569eaf3a635486ddab211d512c85b9df8fb"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule blake2b_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="0d53ec449809fdd17cf090746001868b4dcefbad92b5e6bd2c8735d7ff8840d0f7ead6549b2db722dc320aec527bfc08f1e82ef8950c8059ed0c3bbbae297b4f"
...
rule sha3_224_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="6054971793f7f052aa918b837c4c5ae7815fc9e65f5ba73e9e7ba933"
    $a3="335d5c1d592d95574f90c486ec26b75dfa65c92e5058bbeb98e32a5b"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_256_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="9448db2bf0ebbe93e0fbce9596f768d4f4a91ba5ec4382b85eca41a38f9e4106"
    $a3="8ac76453d769d4fd14b3f41ad4933f9bd64321972cd002de9b847e117435b08b"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_384_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="50877dd70dc402b7aa1006f23f23609380fae01c015cce6080855c3a32e1d55451b93985b7742ed736d4888e928de6cb"
    $a3="713d80421f781abcf2768f42fd1f17541c1fa03f68255d3d1fa4810590fdd77bb2a37d092f4b28fdfed380ba2dfafc7a"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_512_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="e343b78c147abebe27c12ee91b1fec15c7162afff4d58a12fa1a785c12b435cf83fdf6fd4690c53aa9a4a0fdec18e4f7920e64e7bcfe5a6ca3f4b2b313200c17"
...
rule base64_hashed_default_creds_linksys_cisco
{
    meta:
        version = "1.0"
        status = "RELEASED"
