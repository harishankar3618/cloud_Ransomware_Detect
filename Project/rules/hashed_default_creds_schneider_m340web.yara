...
rule mysql323_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{MD5}LkCth56VUgHfTe2/jUeaEg=="
    $a1="{MD5}LkCth56VUgHfTe2/jUeaEg=="
condition:
    ($a0 and $a1)
}

rule ldap_sha1_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{SHA}brDGEgGpavyZy/GA8cjZPAqf2Mg="
    $a1="{SHA}brDGEgGpavyZy/GA8cjZPAqf2Mg="
condition:
    ($a0 and $a1)
}

rule md5_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_schneider_m340web
{
    meta:
        version = "1.0"
        status = "RELEASED"
