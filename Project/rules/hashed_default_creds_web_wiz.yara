...
rule nthash_hashed_default_creds_web_wiz
{
    meta:
        id = "YtgXPLiABDiWlCKtH4RJR"
...
rule mysql323_hashed_default_creds_web_wiz
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_web_wiz
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_web_wiz
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_web_wiz
{
    meta:
        version = "1.0"
        status = "RELEASED"
