...
rule nthash_hashed_default_creds_movistar_ssh
{
    meta:
        id = "2LCqgv9V8mIZMQHdaPNaUE"
        fingerprint = "c0659d7650833ef8f37783642cdfcbd7b6b43be7fbddf658ee706e6a36bc8c08"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
...
rule mysql41_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_movistar_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
