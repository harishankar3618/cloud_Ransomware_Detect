...
rule nthash_hashed_default_creds_kethinov
{
    meta:
        id = "3sn7IeKY9svuYNihfbLVHP"
        ...
        description = "Hashed values of default credentials for kethinov."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_kethinov
{
    meta:
        version = "1.0"
        status = "RELEASED"
