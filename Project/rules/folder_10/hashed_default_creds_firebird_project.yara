...
rule nthash_hashed_default_creds_firebird_project
{
    meta:
        id = "7XKy84C24YQYDjuSxqaRGK"
...
rule mysql323_hashed_default_creds_firebird_project
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_firebird_project
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_firebird_project
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_firebird_project
{
    meta:
        version = "1.0"
        status = "RELEASED"
