...
rule nthash_hashed_default_creds_zcom
{
    meta:
        id = "5QwndvUccShsJxtvgZ7mrc"
        fingerprint = "3610e3e9c444a75ab4b50c0ef71fda3cd136b6098ad21eb2a08be44241387124"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
...
rule mysql323_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_zcom
{
    meta:
        version = "1.0"
        status = "RELEASED"
