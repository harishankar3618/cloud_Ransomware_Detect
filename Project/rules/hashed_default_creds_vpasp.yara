...
rule nthash_hashed_default_creds_vpasp
{
    meta:
        id = "6oEQxynUGC2tcpyHBM0QtS"
...
rule mysql323_hashed_default_creds_vpasp
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_vpasp
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="*B7F2995388623246932ADA26A509DF6586575CB7"
    $a3="*B7F2995388623246932ADA26A509DF6586575CB7"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule ldap_md5_hashed_default_creds_vpasp
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="{MD5}y/RsZmL57MBXp4Gkzqur5w=="
    $a3="{MD5}y/RsZmL57MBXp4Gkzqur5w=="
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule ldap_sha1_hashed_default_creds_vpasp
{
    meta:
        version = "1.0"
        status = "RELEASED"
