...
rule mysql323_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{MD5}e3vCUS7h/tzXa9xokm1Pew=="
    $a1="{MD5}e3vCUS7h/tzXa9xokm1Pew=="
condition:
    ($a0 and $a1)
}

rule ldap_sha1_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{SHA}HtojdYvp425eDSpqh95YSqygGT8="
    $a1="{SHA}HtojdYvp425eDSpqh95YSqygGT8="
condition:
    ($a0 and $a1)
}

rule md5_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_hyland_software_inc
{
    meta:
        version = "1.0"
        status = "RELEASED"
