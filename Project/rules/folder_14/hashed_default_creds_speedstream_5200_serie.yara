...
rule nthash_hashed_default_creds_speedstream_5200_serie
{
    meta:
        id = "1dBbFQLP74EMfyTWVztwXw"
        fingerprint = "874e5435080c8fff399af9eab4fcf2dbbdae9c9b8515bd123d0134bc7709c848"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
        ...
        description = "Hashed values of default credentials for speedstream_5200_serie."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_speedstream_5200_serie
{
    meta:
        version = "1.0"
        status = "RELEASED"
