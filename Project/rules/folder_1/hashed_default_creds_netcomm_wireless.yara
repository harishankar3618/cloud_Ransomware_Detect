...
rule nthash_hashed_default_creds_netcomm_wireless
{
    meta:
        id = "7NF7GtVLFl1QXdnDZljd78"
        fingerprint = "e29a9e956f87489c03763b7f61c6c881198f39ca6837900182f55ae280ba7a81"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
        ...
        description = "Hashed values of default credentials for netcomm_wireless."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_netcomm_wireless
{
    meta:
        version = "1.0"
        status = "RELEASED"
