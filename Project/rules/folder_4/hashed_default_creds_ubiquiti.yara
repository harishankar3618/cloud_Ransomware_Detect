...
rule nthash_hashed_default_creds_ubiquiti
{
    meta:
        id = "7cd1iiIKXqDvF7LFpHOlqZ"
...
rule mysql323_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{MD5}uobyu+EHx8V+tfJpB3XHEg=="
    $a1="{MD5}uobyu+EHx8V+tfJpB3XHEg=="
condition:
    ($a0 and $a1)
}

rule ldap_sha1_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="{SHA}tecByS63TeTWDNwG80nkzwCdrWU="
    $a1="{SHA}tecByS63TeTWDNwG80nkzwCdrWU="
condition:
    ($a0 and $a1)
}

rule md5_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_ubiquiti
{
    meta:
        version = "1.0"
        status = "RELEASED"
