...
rule mysql41_hashed_default_creds_fortinet
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a4="*542D04CCDC88BCFEF2C66726ABE918FA9E0C41D6"
    $a5="*98564E0965AB24A320683D575EBF02DC4E16595E"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}

rule ldap_md5_hashed_default_creds_fortinet
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a4="{MD5}qJ4ZMfe0xwbhS4fGQeT8+w=="
    $a5="{MD5}muVVdaNYiImkYJoBDvZ2fg=="
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a4="242f4b098f186780f9547da35187f4e2bea14cd108c8bc996a36814b"
    $a5="8a6ee7a6e59c5ee453a7674f284daf3c259f929a6c8a9094e546d406"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a4="b33c7c2c2d2680b89e6d1acf253abfe626a6853b1580ef638ef898ab86082d7d"
    $a5="690e36fa8c6440b20da312da2f328bd061f155526fff967b1062f6e30c976ef2"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
...
strings:
    ...
    $a4="b346e046c4193deca8b843990b75b1cbefc7e9ad998f36700d3259113df8745918d4868de69f3fe3a966f7552f69d820"
    $a5="2939d842fe82d218507180743a8a8cfc81077eeaed6c2fa16a1991a89aceaad75195d52ae952b05fbc746528336893ad"
condition:
    ($a0 and $a1) or ($a2 and $a3) or ($a4 and $a5)
}
