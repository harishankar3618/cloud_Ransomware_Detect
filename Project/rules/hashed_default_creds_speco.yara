...
rule nthash_hashed_default_creds_speco
{
    meta:
        id = "12NfLle3drsBFWQI7us1p9"
        fingerprint = "1fa8c5f91af11538b4b0fd5f4f96d138a62edc2e2e2a603ae2258ab4922ca062"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
        ...
        description = "Hashed values of default credentials for speco."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_speco
{
    meta:
        version = "1.0"
        status = "RELEASED"
