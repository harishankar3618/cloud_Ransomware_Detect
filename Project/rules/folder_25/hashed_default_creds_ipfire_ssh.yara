...
rule nthash_hashed_default_creds_ipfire_ssh
{
    meta:
        id = "39JP00H9cAu2brxfJHqgAG"
        fingerprint = "d331267e7634570f8f2c84d476293a2507decfd9c4c38a8926c6da9a5e0f1435"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
        ...
        description = "Hashed values of default credentials for ipfire_ssh."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_ipfire_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
