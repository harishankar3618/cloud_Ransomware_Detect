...
rule nthash_hashed_default_creds_sourcefire
{
    meta:
        id = "1oPNq5igg0NUJUA0Fdlf89"
        fingerprint = "fbd7dff1509fcd3b9da01aacf082606de38b9fa6a1cb45fd1aaebdd14fdf6404"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
...
rule mysql323_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_sourcefire
{
    meta:
        version = "1.0"
        status = "RELEASED"
