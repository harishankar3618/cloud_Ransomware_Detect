...
rule mysql41_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="*FA063F71E278071EF49C92CBBEA012A8BEFE6600"
...
rule ldap_md5_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="abf2efbb461f7e1c84452cd1ffa4f491"
...
rule sha1_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="047c146c1dd8f2bad09a3cbecdfb0afd505124f5"
...
rule sha384_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="d6491e3a69003850b92247fcc2aba1a161b68e5ec6f6263ee4db26c8e05af38f14f22f7e66886a7bb0129159421358e3"
...
rule sha224_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="130832d4137dbe7f3358f1acbe0eca9c2b745db2f9c1f29f031426b43262dc4d3e3d993832d68a882d6f45ef959108ba39c2ef707577c03c9ee8ad339d3e4f75"
...
rule sha256_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="84edb6a537368a4a0780cec78d34024a543475f97ee66f1f14f8a04562608697"
...
rule blake2b_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="711af79d31ba740815c0319172661069831debec1cd76c71eee29861bc14d62971788d16307579c290dbae96033309a7e00294d7ff6d97183abde8ff98a0396d"
...
rule sha3_224_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="f0e68e7c9730f2107747ba945e96baa93d7f6c4b1450268e84a389a99bf6ed6a5e1d3528ed8dacb8e0b4a643db39e3c1"
...
rule sha3_512_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    $a0="ed3980615fac350561fae814ec52546b676fe697ebbf423ba378785ceaf94111875eb9cfa829aedd92200439adcbdc831d2a8b5c0177ec509320ce2dde07b491"
...
rule base64_hashed_default_creds_sophia_schweiz_ag
{
    meta:
        version = "1.0"
        status = "RELEASED"
