...
rule nthash_hashed_default_creds_speedstream
{
    meta:
        id = "2wI8lx3Z5qZemw2DgWvNfj"
        fingerprint = "cad228d8763ef96a3518775eda8f5b6502316868f1932eb00f3d146c8f828a6b"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
        ...
        description = "Hashed values of default credentials for speedstream."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_speedstream
{
    meta:
        version = "1.0"
        status = "RELEASED"
