...
rule nthash_hashed_default_creds_linksys_ssh
{
    meta:
        id = "4pPGepdVscrHeumAURUe0k"
        fingerprint = "e67f4530865e909c9e267722a1b91f65d4c273e9a5ee9040cb476016d31bd2a1"
        version = "1.0"
        modified = "2024-02-15"
        status = "RELEASED"
        sharing = "TLP:WHITE"
        ...
        description = "Hashed values of default credentials for linksys_ssh."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule md5_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha1_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha384_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha224_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha512_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha256_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2b_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule blake2s_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_224_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_256_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_384_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule sha3_512_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule base64_hashed_default_creds_linksys_ssh
{
    meta:
        version = "1.0"
        status = "RELEASED"
