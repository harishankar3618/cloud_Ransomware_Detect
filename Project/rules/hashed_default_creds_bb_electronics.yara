...
rule ldap_md5_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="{MD5}a1LHi9MBFIlaHdyxAqRxhQ=="
    $a3="{MD5}Y6nw6nu5gFB5a2SehUgYRQ=="
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule ldap_sha1_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="{SHA}9emJ06rm7Z0Vv0p5UG5N/WgxkLE="
    $a3="{SHA}3Hbp8MAAbo+RngxRXGbbujmC94U="
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule md5_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="6b52c78bd30114895a1ddcb102a47185"
    $a3="63a9f0ea7bb98050796b649e85481845"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha1_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="f5e989d3aae6ed9d15bf4a79506e4dfd683190b1"
    $a3="dc76e9f0c0006e8f919e0c515c66dbba3982f785"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha384_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="1a35024f4a368614e0c52525cbc8b2c03a01bd1107ec41ee08cb202332a52332adb1df0b561e6cdfca6a743684422d1f"
    $a3="7ed8c2c790aa83d6c3e404b5368f6832c18d46a0e98b9c7a7a5e3ef823e2c9f0e310abbf6f7ea9d9d883ccb64ec2736a"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha224_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="dc24fdc0b7abc43528b023f69b33c17e61853a35362540e894ef6891"
    $a3="871ce144069ea0816545f52f09cd135d1182262c3b235808fa5a3281"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha512_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="ae78eaec2f17303958a31439babf58c6a2e30c49aac058782fa1ed34111ccd3920840619a362a8a2fd16678cb8ac888a7a27fb0ec9a2859426ee849c8898ec4f"
...
rule sha256_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="2bcff26395ad0b54b4781614aeb11bfd95044c3325d410959ffe88f65895cb3e"
    $a3="4813494d137e1631bba301d5acab6e7bb7aa74ce1185d456565ef51d737677b2"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule blake2b_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="af68ece31a74067a0bf2343496f87c4244cac30d3cee7a86ee9b2a40b0e7eff42d1386e0147fa94ac24ce63265008b478ee612579cc8c39f62dff7dc13aa0555"
...
rule blake2s_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="160ca5636854aa206935b9e2589bd31c6ef7ca20aa6b7413e43acbb76e2e54c1"
...
rule sha3_256_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="e927a62efcc9c00f4ef4b19b9af3c914a20cc257dbb30a3ca14317ecab468a2d"
    $a3="a00e4d3b352e9d11979549b9eef5dc951592f594488451e6cd86fdc4bce76a53"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_384_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="b09772bd1a14c439d64379fbae33f9df8a43caa49c68a618b8b063b67da8f492b9d600a29807778236620ece62ba03f8"
    $a3="aac595410801e93eadb099ac575ccc12e43be2c15e31e7991e908329e5beb0729881b3be9ccdb0eeb6eb79335ea38b6d"
condition:
    ($a0 and $a1) or ($a2 and $a3)
}

rule sha3_512_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
strings:
    ...
    $a2="6e7ebc41bff9d74bbb86b5d60ea292024f8573381159599a29d117d21084f918d5db3a85cd81207af5c365bbaa37bb3a527bd590775cef4ce762135735e5ac4c"
...
rule base64_hashed_default_creds_bb_electronics
{
    meta:
        version = "1.0"
        status = "RELEASED"
