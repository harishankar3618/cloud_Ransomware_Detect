...
rule nthash_hashed_default_creds_konica_minolta_web
{
    meta:
        id = "6s0IrpSc5cx5NshboK8kaS"
        ...
        description = "Hashed values of default credentials for konica_minolta_web."
        category = "INFO"
        info = "NTHASH"
...
rule mysql323_hashed_default_creds_konica_minolta_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule mysql41_hashed_default_creds_konica_minolta_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_md5_hashed_default_creds_konica_minolta_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
...
rule ldap_sha1_hashed_default_creds_konica_minolta_web
{
    meta:
        version = "1.0"
        status = "RELEASED"
